...
IMAGE_TAG="acks-markdown-editor:1.0.0-${VCS_REF:0:7}"
...
`npm test` rebuilds the single-file app and runs all five Node test suites.
...
The first stable release is [`v1.0.0`](https://github.com/shynloc/ACKS-Markdown-Editor/releases/tag/v1.0.0).
